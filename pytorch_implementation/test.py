...
parser.add_argument('--model_dir',
                    default='/home/adnankhan/PycharmProjects/HighlightDetection/pytorch_implementation/experiments/base_model',
...
if __name__ == '__main__':
    ...
    # fetch dataloaders
    dataloaders = data_loader.fetch_data_loader(['test'],  args.data_dir, params)
    ...
    # Evaluate
    test_metrics = test(model, loss_fn, test_dl, metrics, params)
