...
from model.net import DistanceNet, accuracy, loss_fn, metrics
from utils import utils as utils
from evaluate_distance_model import evaluate
...
parser.add_argument('--model_dir',
                    default='/home/adnankhan/PycharmProjects/HighlightDetection/pytorch_implementation/experiments/proposed_with_distance',
...
if __name__ == '__main__':
    ...
    # fetch dataloaders
    dataloaders = data_loader.fetch_data_loader(['train', 'val'], args.data_dir, params, dataset_model='DistanceNetDataset')
    ...
    model = DistanceNet().cuda() if params.cuda else DistanceNet()
    ...
    np.savetxt(os.path.join(args.model_dir, 'train_loss_distance_model.npy'), np.array(loss_over_epoch))